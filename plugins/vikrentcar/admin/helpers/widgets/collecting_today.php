...
class VikRentCarAdminWidgetCollectingToday extends VikRentCarAdminWidget
{
	...
	public function __construct()
	{
		...
		$this->widgetName = JText::_('VRCDASHTODAYPICKUP');
		$this->widgetDescr = JText::_('VRC_W_COLLECTTOD_DESCR');
	...
	public function render($data = null)
	{
		...
		<div class="vrc-admin-widget-wrapper">
			<div class="vrc-admin-widget-head vrc-dashboard-today-pickup-head">
				<h4><i class="vrcicn-enter"></i><?php echo JText::_('VRCDASHTODAYPICKUP'); ?> <span class="arrivals-tot"><?php echo $tot_arrivals; ?></span></h4>
				<div class="btn-toolbar pull-right vrc-dashboard-search-pickup">
					<div class="btn-wrapper input-append pull-right">
						<input type="text" class="pickup-search form-control" placeholder="<?php echo JText::_('VRCDASHSEARCHKEYS'); ?>">
			...
			<div class="vrc-dashboard-today-pickup table-responsive">
				<table class="table vrc-table-search-cin">
					...
					if (!count($pickup_today)) {
						?>
						<tr class="warning">
							<td colspan="7"><i class="vrcicn-warning"></i> <?php echo JText::_('VRCNOPICKUPSTODAY'); ?></td>
						</tr>
						<?php
					}
