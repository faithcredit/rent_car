...
class RC2 extends Base
{
     ...
     *
     * @see \VendorDuplicator\phpseclib\Crypt\Base::block_size
     * @var int
     * @access private
     */
    var $block_size = 8;
     ...
     * The Key
     *
     * @see \VendorDuplicator\phpseclib\Crypt\Base::key
     * @see self::setKey()
     * @var string
     * @access private
     */
     ...
     *
     * @see \VendorDuplicator\phpseclib\Crypt\Base::_clearBuffers()
     * @var bool
     * @access private
     */
     ...
     * Key Length (in bytes)
     *
     * @see \VendorDuplicator\phpseclib\Crypt\RC2::setKeyLength()
     * @var int
     * @access private
     */
    var $key_length = 16;
     ...
     * Encrypts a block
     *
     * @see \VendorDuplicator\phpseclib\Crypt\Base::_encryptBlock()
     ...
     * Decrypts a block
     *
     * @see \VendorDuplicator\phpseclib\Crypt\Base::_decryptBlock()
     ...
     *
     * @see \VendorDuplicator\phpseclib\Crypt\Base::_setupMcrypt()
     * @access private
     */
     ...
     *
     * @see \VendorDuplicator\phpseclib\Crypt\Base::_setupInlineCrypt()
     * @access private
     */
