...
class RSA
{
    ...
    /**#@+
     * @access private
     * @see \VendorDuplicator\phpseclib\Crypt\RSA::createKey()
     */
    /**
     * ASN1 Integer
     */
    ...
    /**#@+
     * @access private
     * @see \VendorDuplicator\phpseclib\Crypt\RSA::__construct()
     */
    /**
     ...
     * @access public
     * @see \VendorDuplicator\phpseclib\Crypt\RSA::createKey()
     * @see \VendorDuplicator\phpseclib\Crypt\RSA::setPrivateKeyFormat()
     */
    /**
     ...
     * @access public
     * @see \VendorDuplicator\phpseclib\Crypt\RSA::createKey()
     * @see \VendorDuplicator\phpseclib\Crypt\RSA::setPublicKeyFormat()
     */
    /**
     * Raw public key
     *
     ...
     * Precomputed Zero
     *
     * @var \VendorDuplicator\phpseclib\Math\BigInteger
     * @access private
     */
    var $zero;
    /**
     ...
     * Hash function
     *
     * @var \VendorDuplicator\phpseclib\Crypt\Hash
     * @access private
     */
    var $hash;
    /**
     ...
     *
     * @access private
     * @param \VendorDuplicator\phpseclib\Math\BigInteger $x
     * @param int $xLen
     * @return string
     */
     ...
     * @access private
     * @param \VendorDuplicator\phpseclib\Math\BigInteger $x
     * @param \VendorDuplicator\phpseclib\Math\BigInteger $r
     * @param int $i
     * @return \VendorDuplicator\phpseclib\Math\BigInteger
     */
     ...
     *
     * @access private
     * @param \VendorDuplicator\phpseclib\Math\BigInteger $m
     * @return \VendorDuplicator\phpseclib\Math\BigInteger
     */
    function _rsaep($m)
    {
     ...
     *
     * @access private
     * @param \VendorDuplicator\phpseclib\Math\BigInteger $c
     * @return \VendorDuplicator\phpseclib\Math\BigInteger
     */
    function _rsadp($c)
    {
     ...
     *
     * @access private
     * @param \VendorDuplicator\phpseclib\Math\BigInteger $s
     * @return \VendorDuplicator\phpseclib\Math\BigInteger
     */
    function _rsavp1($s)
    {
