...
abstract class Base
{
     ...
     *
     * @see \VendorDuplicator\phpseclib\Crypt\Base::_hashInlineCryptFunction()
     * @var bool
     * @access private
     */
     ...
     *
     * @see \VendorDuplicator\phpseclib\Crypt\Twofish::setKey()
     * @see \VendorDuplicator\phpseclib\Crypt\Twofish::setIV()
     * @var bool
     * @access private
     */
    var $enchanged = \true;
